    ...
    <div>
      <div className="flex md:flex-row flex-col justify-between w-[80%] mx-auto  min-h-[90vh] items-center">
        <div className="md:w-[50%] w-[100%] md:text-left text-center md:mt-0 mt-[5em]">
          <p
            className="md:text-[42px] text-[32px] font-bold text-black"
            data-aos="fade-in"
          ...
          <p
            className="text-[18px] py-4 text-black md:w-[80%] w-[100%]"
            data-aos="fade-in"
          ...
          <div data-aos="fade-up" data-aos-duration="3000">
            <Button
              text="Get Started"
              css="bg-black mt-[2em] py-[1em] text-white text-[14px]"
            />
          </div>
        </div>
      ...
      <div className="bg-[url('assets/money.jpg')] py-[7em] w-[100%] bg-cover bg-center relative">
        ...
        <div className="w-[85%] mx-auto flex md:flex-row flex-col justify-between items-center h-[90%] ">
          ...
          <div className="z-[88] md:w-[50%] w-[100%]">
            <p
              className="md:text-[48px] text-[32px] font-bold text-white"
              data-aos="fade-in"
              data-aos-duration="3000"
            >
            ...
            <p
              ...
              data-aos-duration="3000"
            >
              Investing somewhere else? Transfer over $5,000 and we'll pay the
            ...
            <div data-aos="fade-up" data-aos-duration="3000">
              <Button
                text="Get Started"
                css="bg-white mt-[2em] md:py-[1em] py-[9px] text-[14px] text-black"
              />
            </div>
          </div>
        </div>
